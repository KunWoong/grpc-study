...
var file_product_info_proto_rawDesc = []byte{
	...
	0x72, 0x6f, 0x74, 0x6f, 0x12, 0x11, 0x65, 0x63, 0x6f, 0x6d, 0x6d, 0x65, 0x72, 0x63, 0x65, 0x2e,
	...
	,
...
var file_product_info_proto_goTypes = []interface{}{
	...
	(*ProductID)(nil), // 1: ecommerce.product.ProductID
}
var file_product_info_proto_depIdxs = []int32{
	0, // 0: ecommerce.product.ProductInfo.addProduct:input_type -> ecommerce.product.Product
	1, // 1: ecommerce.product.ProductInfo.getProduct:input_type -> ecommerce.product.ProductID
	1, // 2: ecommerce.product.ProductInfo.addProduct:output_type -> ecommerce.product.ProductID
	0, // 3: ecommerce.product.ProductInfo.getProduct:output_type -> ecommerce.product.Product
...
func (c *productInfoClient) AddProduct(ctx context.Context, in *Product, opts ...grpc.CallOption) (*ProductID, error) {
	out := new(ProductID)
	err := c.cc.Invoke(ctx, "/ecommerce.product.ProductInfo/addProduct", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *productInfoClient) GetProduct(ctx context.Context, in *ProductID, opts ...grpc.CallOption) (*Product, error) {
	out := new(Product)
	err := c.cc.Invoke(ctx, "/ecommerce.product.ProductInfo/getProduct", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _ProductInfo_AddProduct_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/ecommerce.product.ProductInfo/AddProduct",
	}
...
func _ProductInfo_GetProduct_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/ecommerce.product.ProductInfo/GetProduct",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var _ProductInfo_serviceDesc = grpc.ServiceDesc{
	ServiceName: "ecommerce.product.ProductInfo",
